...
function MultiMatrices() {
    ...
    if (colsA !== rowsB) {
        alert('El número de columnas de la Matriz A debe ser igual al número de filas de la Matriz B para poder multiplicar.');
        return;
    }
    ...
    const resultado = MultiMatricesInternamente(matrizA, matrizB);
...
function MultiMatricesInternamente(matrizA, matrizB) {
    let resultado = [];
